...
// src/routes/index.ts
var router7 = Router7();
router7.use("/categories", categoryRoutes);
router7.use("/tutors", tutorRoutes);
router7.use("/bookings", bookingRoutes);
