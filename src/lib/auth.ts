...
export const auth = betterAuth({
  ...
  advanced: {
    ...
    defaultCookieAttributes: {
      ...
      partitioned: process.env.NODE_ENV === "production", // Required for cross-origin cookies in modern browsers
    },
  },
  user: {
    additionalFields: {
  ...
  emailVerification: {
    ...
    sendVerificationEmail: async ({ user, url, token }, request) => {
      try {
        // Use Better Auth's verify endpoint with callbackURL to redirect after verification
